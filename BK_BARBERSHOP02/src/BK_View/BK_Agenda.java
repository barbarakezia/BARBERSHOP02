 ...
 * @author BK_Brandao
 */
public class BK_Agenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelAgendaPainelFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BK_View/imagens/Agenda-PainelFundo.png"))); // NOI18N
        getContentPane().add(LabelAgendaPainelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 1000));

        LabelAgendaFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BK_View/imagens/AgendaFundo.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BK_Agenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
