...
import BK_Controller.BK_LoginController;
import BK_DAO.BK_ConexaoDB;
 ...
 * @author BK_Brandao
 */
public class BK_Login extends javax.swing.JFrame {

    private final BK_LoginController controller;


    public BK_Login() {
        initComponents();
        controller = new BK_LoginController(this);
        BK_ConexaoDB.inicia();
    }
    ...
    private void initComponents() {
        ...
        LabelPainelFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BK_View/imagens/painel-login.png"))); // NOI18N
        getContentPane().add(LabelPainelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 590, 520));

        LabelLoginFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BK_View/imagens/Logo.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BK_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
